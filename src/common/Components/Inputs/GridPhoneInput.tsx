...
const GridPhoneInput: React.FC<PhoneInputProps> = ({ id, label, formik, ...props }) => {
    ...
    return (
        <>
            <label id={`label_${id}`} htmlFor={id} className='text-sm items-center text-end text-gray-800'>{label}</label>
